...
import space.impact.impact_compat.addon.gt.features.steam_age.recipes.STEAM_EXTRACTOR_RECIPE_MAP
import space.impact.impact_compat.addon.gt.features.steam_age.recipes.STEAM_FORGE_HAMMER_RECIPE_MAP

fun addSteamAgeExtractorRecipes() {
    GT_Values.RA.stdBuilder()
        ...
        .eut(0)
        .addTo(STEAM_EXTRACTOR_RECIPE_MAP)
