...
interface CompatBaseItemContainer : IItemContainer {

    var mStack: ItemStack
    ...
    override fun getItem(): Item? {
        if (mHasNotBeenSet) {
            throw IllegalAccessError("The Enum '$nameItem' has not been set to an Item at this time!")
        }
        return if (GT_Utility.isStackInvalid(mStack)) null else mStack.item
    }
