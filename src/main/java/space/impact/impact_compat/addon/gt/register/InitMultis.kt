...
import space.impact.impact_compat.addon.gt.features.steam_age.machines.metallurgy.MultiMetallurgyCaster
import space.impact.impact_compat.addon.gt.features.steam_age.machines.metallurgy.MultiMetallurgySmelter
...
fun initMultis() {
    ...
    CompatMultis.PRIMITIVE_SMELTER set MultiMetallurgySmelter(offsetId++).getStackForm(1)
    CompatMultis.PRIMITIVE_SMELTER set MultiMetallurgyCaster(offsetId++).getStackForm(1)
